          ...
          <div className="md:grid md:grid-cols-2 gap-8">
            ...
            <CardContent className="space-y-6 p-8">
              ...
              <div className="border-t border-b border-gray-200 py-4 space-y-2">
                {product.pack && <div className="flex items-center gap-2"><Package size={20} className="text-purple-600" /><span><strong>Pack:</strong> {product.pack}</span></div>}
                {product.sheets && <div className="flex items-center gap-2"><Package size={20} className="text-purple-600" /><span><strong>Sheets:</strong> {product.sheets}</span></div>}
                {product.pulls && <div className="flex items-center gap-2"><Package size={20} className="text-purple-600" /><span><strong>Pulls:</strong> {product.pulls}</span></div>}
                {product.ply && <div className="flex items-center gap-2"><Package size={20} className="text-purple-600" /><span><strong>Ply:</strong> {product.ply}</span></div>}
              </div>
