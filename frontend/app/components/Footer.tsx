  ...
  return (
    ...
    <footer className="bg-gray-400 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <img
              ...
              className="mb-5"
            />
            <p className="text-gray-900">Nepal&apos; #1 Premium Tissue Brand - Bringing comfort and quality to every home.</p>
          </div>
          <div>
        ...
        <div className="border-t border-gray-900 mt-8 pt-2 text-center text-gray-900">
